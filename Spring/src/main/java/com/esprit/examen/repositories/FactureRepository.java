...
public interface FactureRepository extends JpaRepository<Facture, Long> {
	...
	@Query("SELECT f FROM Facture f where f.fournisseur=:fournisseur and f.archive=false")
